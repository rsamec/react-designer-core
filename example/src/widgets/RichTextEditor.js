	...
	render() {
		...
		<div>
			<div className="RichEditor-root">
				<div style={style} className={className} onClick={this.focus} onMouseEnter={this.toolboxToggle.bind(this)} onMouseLeave={this.toolboxToggle.bind(this)}>
					<Editor
			...
			<Overlay
				...
				container={this}
				target={ props => ReactDOM.findDOMNode(this.refs.editor)}
			>
				<Toolbox>
					{/*<BlockStyleControls
						editorState={editorState}
