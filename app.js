...
var App = React.createClass({displayName: "App",
    ...
    getInitialState:function () {
        ...
        return {data:_.extend({dataSources:dataSources},  this.props.data || this.props.schema.props.defaultData)};
        ...
        return (
            React.createElement("html", null, 
                React.createElement("head", null,
                    React.DOM.link({href:'https://fonts.googleapis.com/css?family=Courgette|Great+Vibes|Patrick+Hand|Indie+Flower|Lobster|Poiret+One|Press+Start+2P|Open+Sans:400,700,700italic,400italic|Roboto:400,400italic,700,700italic|Lato:400,700italic,400italic,700|Oswald:400,700|Slabo+27px', rel:'stylesheet', type:'text/css'}),
